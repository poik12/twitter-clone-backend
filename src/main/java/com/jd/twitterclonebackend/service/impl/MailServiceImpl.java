...
import com.jd.twitterclonebackend.exception.InvalidEmailEnum;
...
public class MailServiceImpl implements MailService {
    ...
    // Email Properties
    private static final String ACTIVATION_LINK = "http://localhost:8080/api/user/confirm?token=";
    ...
    public NotificationEmailDto createActivationEmailForUser(UserEntity userEntity, String verificationToken) {
        ...
        return NotificationEmailDto.builder()
                ...
                .activationLink(ACTIVATION_LINK + verificationToken)
                .build();
    }
